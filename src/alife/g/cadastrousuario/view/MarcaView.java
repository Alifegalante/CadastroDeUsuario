...
import alife.g.cadastrousuario.controller.MarcaController;
...
public class MarcaView extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBorder(javax.swing.BorderFactory.createTitledBorder("Lista de marcas"));
    ...
    private void jbtCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtCancelarActionPerformed
        ...
        this.limparCampos();
        this.controller.setMarcaManipulada(null);
    }//GEN-LAST:event_jbtCancelarActionPerformed

    private void jbtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtSalvarActionPerformed
        if (!(this.controller.getMarcaManipulada()== null)) {
            try {
                this.validarForm();
                enviarForm();
    ...
    private void jbtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtExcluirActionPerformed
        ...
        if (
                (!(this.controller.getMarcaManipulada()== null))
                &&
                (this.controller.getMarcaManipulada().getCodigo()!=null)
                ) {
                ...
                if (lista.size() > 0) {
                    for (int i = 0; i < lista.size(); i++) {
                        if (lista.get(i).getCodigo().equals(parseInt)) {
                            this.controller.setMarcaManipulada(lista.get(i));
                            this.recebeForm();
...
//    Fazer receber os dados para o form
    ...
    private void enviarForm() {
        ...
        if (this.jtfCodigo.getText().equals("")) {
            this.controller.getMarcaManipulada().setCodigo(null);
        } else {
            this.controller.getMarcaManipulada()
    ...
    private void recebeForm() {
        jtfCodigo.setText(this.controller.getMarcaManipulada().getCodigo().toString());
        jtfNome.setText(this.controller.getMarcaManipulada().getNome());
    }
