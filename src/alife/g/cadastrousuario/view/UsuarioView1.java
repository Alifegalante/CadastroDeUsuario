 ...
 */
package alife.g.cadastrousuario.view;

import alife.g.cadastrousuario.controller.UsuarioController;
 ...
 */
public class UsuarioView1 extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jbtAltSenha = new javax.swing.JButton();
        jScrollPane1 = new javax.swing.JScrollPane();
        jtbLista = new javax.swing.JTable();

        setClosable(true);
        setTitle("Cadastro de Usuário - Senha Criptografada");
        ...
        jbtAltSenha.setText("inserir/alterar");
        jbtAltSenha.setEnabled(false);
        jbtAltSenha.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jbtAltSenhaActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(0, 0, Short.MAX_VALUE))
                    .addComponent(jbtAltSenha, javax.swing.GroupLayout.DEFAULT_SIZE, 142, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void jbtAltSenhaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtAltSenhaActionPerformed
        try {
            ...
            BigInteger hash = new BigInteger(1, md.digest(new String(jpwSenha.getPassword()).getBytes()));
            senhaMD5 = String.format("%32x", hash);
            JOptionPane.showMessageDialog(this, "Senha alterada, salve para confirmar!");
            jpwSenha.setText("");
    ...
    }//GEN-LAST:event_jbtAltSenhaActionPerformed
...
//    Fazer receber os dados para o form
    ...
    private javax.swing.JButton jbtAltSenha;
    ...
    private void recebeForm() {
        ...
        senhaMD5 = this.controller.getUsuarioManipulado().getSenha();
    }
    
    private void validarForm() throws Exception {
        if (senhaMD5 == null) {
            throw new Exception("É preciso inserir uma senha!");
        }
